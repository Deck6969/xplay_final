...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', '74.208.14.162'))
FQDN = str(getenv('FQDN', BIND_ADRESS)) if not ON_HEROKU or getenv('FQDN','74.208.14.162:8080') else APP_NAME+'.herokuapp.com'
...
STREAM_LOGS = environ.get('STREAM_LOGS','-1002004933941') #changed
SESSION = environ.get('SESSION','MissRozy')
CUSTOM_CAPTION = environ.get('CUSTOM_CAPTION')


class Config(object):
	API_ID = int(os.environ.get("API_ID", 24292921)) #changed
	API_HASH = os.environ.get("API_HASH", "10a7f73cdaab359bc680c356763a41ab") #changed
	BOT_TOKEN = os.environ.get("BOT_TOKEN","7183532699:AAHtnxa7oM5jqgP1_trnzZUym6E1CaU4EcA") #changed
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "xplay_server_bot") #changed
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1002131659740)) #changed
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "6205121295")) #changed
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://aman9324864707:8011396429@xplay.k4b4opp.mongodb.net/?retryWrites=true&w=majority&appName=xplay")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002131632485") #changed
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1002046140350") #changed
